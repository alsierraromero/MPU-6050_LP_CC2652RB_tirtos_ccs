...
const I2C_Config I2C_config[CONFIG_I2C_COUNT] = {
    ...
    /* BAS Sensors Mark II I2C */
    {
        .object      = &i2cCC26xxObjects[I2C_ACCEL],
        .hwAttrs     = &i2cCC26xxHWAttrs[I2C_ACCEL]
    },
};

const uint_least8_t I2C_ACCEL_CONST = I2C_ACCEL;
...
const PIN_Config BoardGpioInitTable[CONFIG_PIN_COUNT + 1] = {
    ...
    /* BAS Sensors Mark II I2C, Parent Signal: I2C_ACCEL SDA, (DIO5) */
    CONFIG_PIN_4 | PIN_INPUT_EN | PIN_PULLUP | PIN_IRQ_DIS,
    /* BAS Sensors Mark II I2C, Parent Signal: I2C_ACCEL SCL, (DIO4) */
